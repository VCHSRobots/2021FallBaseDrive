...
import frc.vision.messages.HeartbeatMessage;
import frc.vision.messages.OffWireMessage;
import frc.vision.messages.VisionMessage;
...
public class VisionServer extends CrashTrackingRunnable {
    ...
    private static int kAndroidAppTcpPort=3000;
